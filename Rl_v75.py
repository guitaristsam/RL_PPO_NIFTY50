# Rl_v75.py — UNRUN single-variable fork of Rl_v18.py.
...
# late-training memorization that the diagnosed val-decay-past-100k reflects,
# without shrinking capacity or features. 0.02 is the SB3-suggested starting
# value. See variants.md "Rl_v75.py".
# Run: `python run_panel.py v75`   (do NOT run frozen files).
import os
...
def train_ppo_model(train_df, tech_indicators, stock_name, total_timesteps=200000,
    ...
    PPO_PARAMS = {
        ...
        "vf_coef": 0.5,
        "max_grad_norm": 0.5,
        "target_kl": 0.02,        # v75: adaptive KL early-stop of the epoch loop (was None)
        "verbose": 1,
        "seed": 42,
        "device": "auto",
