# ===========================================================================
# Rl_v80.py — UNRUN DESIGN DRAFT (auto/research 2026-09-07). Single-variable
# fork of the PRODUCTION CHAMPION Rl_v18.py. The ONLY change vs Rl_v18.py is
# the discount factor gamma: 0.99 -> 0.97 (agent gamma AND the matching
# VecNormalize return-normalization gamma move together — they are the same
# discount). Rationale: DISCOUNT-AS-REGULARIZER (Jiang 2015; Amit et al.
# ICML 2020) — a shorter effective planning horizon shrinks the effective
# policy class, the same overfit lever the empirical proxy screen already
# favours via capacity-reduction. gamma 0.99->0.95 scored +5pp twice on the
# proxy; 0.97 is the "sweet spot" between the +5pp signal and 0.99. Distinct
# from the REJECTED constant-LR / n_epochs / regularization levers: this is
# the discount, an untried single knob. See variants.md "Rl_v80.py".
# NOTE: gamma=0.97 => effective horizon ~1/(1-0.97)=33 bars (~1.5 trading
# months) vs ~100 bars at 0.99. Everything else BYTE-IDENTICAL to v18.
# ===========================================================================
import os
