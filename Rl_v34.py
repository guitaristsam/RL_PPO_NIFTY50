# ===========================================================================
# Rl_v34.py — UNRUN DESIGN DRAFT (auto/research 2026-09-02). DO NOT treat as
# a validated baseline. Single-variable fork of the v26 CHAMPION (22 curated
# indicators): the ONLY change vs Rl_v26.py is enabling gSDE (generalized
# State-Dependent Exploration) on the continuous Box[-1,1] action space —
...
def train_ppo_model(train_df, tech_indicators, stock_name, total_timesteps=200000,
    ...
    PPO_PARAMS = {
        ...
        "ent_coef": 0.01,
        # v34: gSDE smooth state-dependent exploration on the continuous action.
        "use_sde": True,
        "sde_sample_freq": 4,
        "vf_coef": 0.5,
        "max_grad_norm": 0.5,
